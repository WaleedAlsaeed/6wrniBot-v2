...
exports.default = new Button_1.RoleButton("sound", (interaction) => __awaiter(void 0, void 0, void 0, function* () {
    const member = interaction.member;
    const role = member.guild.roles.cache.get("778149668076519426");
    if (!member || !role)
        return;
