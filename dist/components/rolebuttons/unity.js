...
exports.default = new Button_1.RoleButton("unity", (interaction) => __awaiter(void 0, void 0, void 0, function* () {
    const member = interaction.member;
    const role = member.guild.roles.cache.get("778149036779110410");
    if (!member || !role)
        return;
