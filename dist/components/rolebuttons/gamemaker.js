...
exports.default = new Button_1.RoleButton("gamemaker", (interaction) => __awaiter(void 0, void 0, void 0, function* () {
    const member = interaction.member;
    const role = member.guild.roles.cache.get("778149492595621918");
    if (!member || !role)
        return;
