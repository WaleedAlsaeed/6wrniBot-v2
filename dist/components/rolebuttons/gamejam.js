...
exports.default = new Button_1.RoleButton("gamejam", (interaction) => __awaiter(void 0, void 0, void 0, function* () {
    const member = interaction.member;
    const role = member.guild.roles.cache.get("1039879858987204661");
    if (!member || !role)
        return;
